...
function computeGost10198I1(input){
  ...
  // II-1, src/ii1/calc.js). У типа I-1 у каждой детали своя
  ...
  // (неокруглённая) толщина, что и t9 выше; при планке - толщина планки дна (планка
  // правилу "в наличии" подчиняется как обычно). Каждая толщина - своей детали (T ниже).
