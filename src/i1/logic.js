...
// Количество планок (боковой щит / крышка): 2 крайние на расстоянии
// boardLen/6 от каждого края (без верхнего предела на отступ, в отличие от
// типа I-3) + промежуточные так, чтобы расстояние между соседними планками
// не превышало 700мм. Если отступ с двух сторон не умещается в длину доски -
// расчёт для этого узла невозможен (см. calculate() - жёсткий блок).
function plankCount(boardLen){
  ...
  return {count: ceilInt(middle/700)+2, edgeDist, middle};
}
