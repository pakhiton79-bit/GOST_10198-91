...
const BOX_I1_IMG_B64 = "data:image/jpeg;base64,__IMG:box_i1.jpg__";
...
// остальных чертежей I-1 - по общей высоте рамки щита framePx (см.
// i1PageFramePx ниже): высота рамки торца на фото - 1107px (с раскосиной,
...
// calc.js): если на узком экране какому-то чертежу всё же не хватает места
...
// 4 пояса, поэтому масштаб (высота рамки, см. i1PageFramePx) у всех вариантов
