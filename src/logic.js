...
function selectSkid19(mass, workingLengthMm, widthMm){
  ...
  if(valid.length===0){
    // ни один вариант из таблицы не даёт нужное количество полозьев -
    // берём максимальное доступное в этой строке массы и предупреждаем
    valid = [options.reduce((a,b)=> b.count>a.count ? b : a)];
