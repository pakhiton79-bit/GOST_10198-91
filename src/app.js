...
function calculate(){
  ...
  tablesHtml += `<div class="part-title">Крышка</div><div class="spec-row-diagram"><div class="diagram-slot">` + diagramKryshka(W, L, t30, t32, t41, t40Display, edgeDistKryshka, l21, w21, l19, bokSectionW) + `</div>` + renderSection('', kryshka) + `</div>`;
