...
// (м³/ч) * коэффициент времени. Оба параметра настраиваются двумя
// ползунками с фиксированными остановками (плюс поле ручного ввода любого
// значения) - по умолчанию 0.06 м³/ч и коэффициент 1.2 (середина списков
// остановок обоих ползунков).
