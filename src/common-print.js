...
// computeGost... вернул calc.error) или null/любое другое значение - все
// три скрыты (до первого расчёта, либо только что открытая пустая форма).
...
// renderDiagram() в src/common-diagrams.js) - живой <svg class="diagram-arrows">
...
// картинки в #boardTables (тот же base64, что и в клоне) уже отрисованы на
...
// data-size-group на .diagram-slot (проставляется в HTML, см. напр. calc.js
