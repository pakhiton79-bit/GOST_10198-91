...
function computeGost10198II1(input){
  ...
  // Пространство для досок торца - то же самое, что и у досок крышки при
  // продольном расположении (по уточнению пользователя): ширина груза +
  // (ТОЛЩИНА стойки + толщина обшивки)*2 = outerW, а не отдельная формула
  // через ШИРИНУ стойки (100мм) - несмотря на то, что в тексте источника
  // для этой строки буквально написано "ширина стойки торца".
