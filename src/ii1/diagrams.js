...
// торцевого (TOREC_VARIANTS выше) один в один - по прямому указанию
...
// численно равен L, см. k43 в calc.js). Остальные параметры (longbeamVal,
// skinVal, heightVal, floorHeightVal) - те же самые величины, что и у торца
// (bokFrame.floors/bokFrame.len совпадают с torecFrame.floors/.len - обе рамы
// строятся от одной и той же общей высоты панели, см. calc.js). Подбор
// схемы (какое фото - 2/3/4 стойки, 1/2 этажа - показать при расчётном
// количестве стоек бока) не менялся - тот же приём, что и раньше
// (nearestBokVariant), просто теперь ищет вариант среди TOREC_VARIANTS.
